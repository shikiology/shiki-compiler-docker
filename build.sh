...
docker image rm docker.io/andatoshiki/shiki-compiler:${TOOLKIT_VER}-debian10 >/dev/null 2>&1
docker buildx build . --load --tag docker.io/andatoshiki/shiki-compiler:${TOOLKIT_VER}-debian10
